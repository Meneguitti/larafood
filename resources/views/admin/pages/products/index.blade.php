...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('products.index') }}" class="active">Historias</a></li>
    </ol>

    <h1>Historias <a href="{{ route('products.create') }}" class="btn btn-dark">Adicionar Historia</a></h1>
@stop
